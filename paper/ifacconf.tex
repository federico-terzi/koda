...
\author[First]{Matteo Pellegrino} 
\author[Second]{Federico Terzi} 
...
due to the text printed on the document itself (as seen in TODO REF (B)).

In order to mitigate the problem, a \textit{Gaussian filter} [TODO REF] is applied, obtaining
a clear highlighting of the interesting edges (as seen in TODO REF (C)).
...
work in all real-world scenarios. In particular, Canny's parameters tuning turned out to be a major
problem, as it can be seen in Fig [TODO REF].
